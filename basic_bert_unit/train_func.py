...
def train(Model,Criterion,Optimizer,Train_gene,train_ill,test_ill,entid2data, path2data):
    ...
    for epoch in range(EPOCH_NUM):
        ...
        if epoch >= 0:
            if epoch !=0:
                save(Model,train_ill,test_ill,entid2data, path2data, epoch)
...
def save(Model,train_ill,test_ill,entid2data, path2data,epoch_num):
    ...
    other_data = [train_ill,test_ill,entid2data, path2data]
